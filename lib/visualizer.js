...
const formatNumber = require('./parsers/formatNumber.js');
const getRevenueByFormat = require('./parsers/getRevenueByFormat.js')(OPTIONS);
const getIncomeByFormat = require('./parsers/getIncomeByFormat.js')(OPTIONS);
const getTaxesByFormat = require('./parsers/getTaxesByFormat.js')(OPTIONS);
const getRevenueByClient = require('./parsers/getRevenueByClient.js')(OPTIONS);
const getRevenue = require('./parsers/getRevenue.js')(OPTIONS);
